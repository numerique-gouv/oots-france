...
**Les écarts relevés à ce jour** entre ce que les TDD publient sous trois formes : la prose et les tables des chapitres [4.5.1](https://ec.europa.eu/digital-building-blocks/sites/spaces/TDD/pages/973932961) et [4.5.2](https://ec.europa.eu/digital-building-blocks/sites/spaces/TDD/pages/973932951), les règles Schematron — [`EDM-REQ-C.sch`](https://code.europa.eu/oots/tdd/tdd_chapters/-/blob/2.0.1/OOTS-EDM/sch/EDM-REQ-C.sch), [`EDM-REQ-S.sch`](https://code.europa.eu/oots/tdd/tdd_chapters/-/blob/2.0.1/OOTS-EDM/sch/EDM-REQ-S.sch), [`EDM-RESP-C.sch`](https://code.europa.eu/oots/tdd/tdd_chapters/-/blob/2.0.1/OOTS-EDM/sch/EDM-RESP-C.sch) et [`EDM-RESP-S.sch`](https://code.europa.eu/oots/tdd/tdd_chapters/-/blob/2.0.1/OOTS-EDM/sch/EDM-RESP-S.sch) —, et les XSD. **C'est le `.sch` qui fait foi** partout où il tranche — il est la forme exécutable des règles, et celle que jouent les services de test de la Commission —, et **l'assertion prime son propre message**, qui n'est qu'une phrase à côté d'un test. L'écart sur le titre d'`IsConformantTo` est le seul qu'aucune assertion ne tranche : il porte donc sa propre règle d'arbitrage, dite dans sa ligne.
