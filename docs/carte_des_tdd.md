...
**Les écarts relevés à ce jour** entre ce que les TDD publient sous trois formes : la prose et les tables des chapitres [4.5.1](https://ec.europa.eu/digital-building-blocks/sites/spaces/TDD/pages/973932961), [4.5.2](https://ec.europa.eu/digital-building-blocks/sites/spaces/TDD/pages/973932951) et [4.5.3](https://ec.europa.eu/digital-building-blocks/sites/spaces/TDD/pages/973932938), les règles Schematron — [`EDM-REQ-C.sch`](https://code.europa.eu/oots/tdd/tdd_chapters/-/blob/2.0.1/OOTS-EDM/sch/EDM-REQ-C.sch), [`EDM-REQ-S.sch`](https://code.europa.eu/oots/tdd/tdd_chapters/-/blob/2.0.1/OOTS-EDM/sch/EDM-REQ-S.sch), [`EDM-RESP-C.sch`](https://code.europa.eu/oots/tdd/tdd_chapters/-/blob/2.0.1/OOTS-EDM/sch/EDM-RESP-C.sch), [`EDM-RESP-S.sch`](https://code.europa.eu/oots/tdd/tdd_chapters/-/blob/2.0.1/OOTS-EDM/sch/EDM-RESP-S.sch), [`EDM-ERR-C.sch`](https://code.europa.eu/oots/tdd/tdd_chapters/-/blob/2.0.1/OOTS-EDM/sch/EDM-ERR-C.sch) et [`EDM-ERR-S.sch`](https://code.europa.eu/oots/tdd/tdd_chapters/-/blob/2.0.1/OOTS-EDM/sch/EDM-ERR-S.sch) —, et les XSD. **C'est le `.sch` qui fait foi** partout où il tranche — il est la forme exécutable des règles, et celle que jouent les services de test de la Commission —, et **l'assertion prime son propre message**, qui n'est qu'une phrase à côté d'un test. Deux écarts échappent à cet arbitrage et portent chacun le leur, dit dans sa ligne : le titre d'`IsConformantTo`, qu'aucune assertion ne tranche, et le rôle de `R-EDM-ERR-C013`, où c'est le `.sch` qui se contredit lui-même.
