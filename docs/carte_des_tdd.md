...
**Les écarts relevés à ce jour**, entre les tables des chapitres [4.5.1](https://ec.europa.eu/digital-building-blocks/sites/spaces/TDD/pages/973932961) et [4.5.2](https://ec.europa.eu/digital-building-blocks/sites/spaces/TDD/pages/973932951) et les règles publiées avec elles — [`EDM-REQ-C.sch`](https://code.europa.eu/oots/tdd/tdd_chapters/-/blob/2.0.1/OOTS-EDM/sch/EDM-REQ-C.sch), [`EDM-RESP-C.sch`](https://code.europa.eu/oots/tdd/tdd_chapters/-/blob/2.0.1/OOTS-EDM/sch/EDM-RESP-C.sch) et [`EDM-RESP-S.sch`](https://code.europa.eu/oots/tdd/tdd_chapters/-/blob/2.0.1/OOTS-EDM/sch/EDM-RESP-S.sch), lues à l'étiquette `2.0.1`. **C'est le `.sch` qui fait foi** partout où il tranche — il est la forme exécutable des règles, et celle que jouent les services de test de la Commission. L'écart sur le titre d'`IsConformantTo` est le seul qu'aucune assertion ne tranche : il porte donc sa propre règle d'arbitrage, dite dans sa ligne.
