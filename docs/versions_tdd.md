...
Le chapitre [4.6](https://ec.europa.eu/digital-building-blocks/sites/spaces/TDD/pages/973932928) n'est pas le même texte aux deux étiquettes, et une requête reçue est jugée par les règles de la ligne qu'elle annonce ([4.7 §2.6.2](https://ec.europa.eu/digital-building-blocks/sites/spaces/TDD/pages/973932931)). Six règles en sortent différentes, et `EdmSpecification` porte un prédicat pour chacune :
