...
| [3.7 — Sécurité](https://ec.europa.eu/digital-building-blocks/sites/spaces/TDD/pages/973932927) | Partiel | Le profil TLS a été confronté à la configuration réelle : trois écarts, tous sur des exigences en *should* et tous réparables au même endroit, et la validation DNSSEC reste à établir — le constat exigence par exigence est dans [securite_transport.md](securite_transport.md) | [Common Services](https://linear.app/pole-api/project/oots-france-common-services-ce-qui-reste-8202ee4f0bad) |
