...
# instead — stub 10 of `docs/reste_à_faire.md`. `T3` is declared so the
# end-to-end scenario can exercise the refusal path: any code other than those
# two gets an `EDM:ERR:0004` back. It is the recognition of diplomas, not the
