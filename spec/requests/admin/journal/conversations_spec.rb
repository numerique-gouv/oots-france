...
RSpec.describe 'Admin::Conversations' do
  describe 'both halves of the four-corner model' do
    ...
    describe 'an exchange France did not open' do
      it 'holds its line, and says which way it goes' do
        ...
        get admin_journal_conversations_path

        expect(response.body).to include('venue-d-ailleurs')
        expect(response.body).to include(I18n.t('admin.journal.conversations.directions.incoming'))
      end
  ...
  describe 'GET /admin/journal/conversations' do
    before { sign_in }
    ...
    it 'says where the reader stands' do
      ...
      expect(response.parsed_body.css(".fr-breadcrumb__link[aria-current='true']").text)
        .to eq(I18n.t('admin.journal.conversations.index.title'))
    end
    ...
    it 'narrows on a status' do
      ...
      get admin_journal_conversations_path(status: 'delivered')
    ...
    it 'narrows on the country, whatever its case' do
      ...
      get admin_journal_conversations_path(country_code: 'fi')
    ...
    it 'narrows on the requester' do
      ...
      get admin_journal_conversations_path(evidence_requester_id: '11111111111111')
    ...
    it 'narrows on the procedure' do
      ...
      get admin_journal_conversations_path(procedure_code: '00')
    ...
    it 'narrows on a period' do
      ...
      get admin_journal_conversations_path(depuis: 3.days.ago.to_date.iso8601)
    ...
    describe 'a criterion it cannot honour' do
      it 'shows nothing for a status the model does not have, and says so' do
        ...
        get admin_journal_conversations_path(status: 'livree')
      ...
      it 'shows nothing for a date it cannot read, and says so' do
        ...
        get admin_journal_conversations_path(depuis: 'pas-une-date')
      ...
      it 'says so when the period is read the wrong way round' do
        ...
        get admin_journal_conversations_path(depuis: '2026-08-20', jusqu_a: '2026-08-10')
    ...
    describe 'paging' do
      ...
      it 'carries the active criteria into the page links' do
        ...
        get admin_journal_conversations_path(status: 'failed')

        expect(response.body).to include(CGI.escapeHTML(admin_journal_conversations_path(status: 'failed', page: 2)))
      end
      ...
      it 'survives a page number no database could offset to' do
        ...
        get admin_journal_conversations_path(page: '99999999999999999999999999')
      ...
      it 'never claims a total it does not show' do
        ...
        get admin_journal_conversations_path(page: 999_999)
  ...
  describe 'GET /admin/journal/conversations/:id' do
    ...
    it 'answers 404 for an unknown conversation' do
      get admin_journal_conversation_path('inconnue')
