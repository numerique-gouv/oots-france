...
RSpec.describe Settings do
  # `SettingsEnvironment` builds it, the initializer of the worker being verified
  # against the same one; the short name is what the examples below read.
  def filled = complete_environment
