...
| `PLAN` | Réponds : approuve, ou dis ce qui change — **et écris-le dans le fichier de plan**, en tête, daté (« Décision du AAAA-MM-JJ : … »), jamais dans le prompt : le ticket et le plan font foi contre le prompt, et une correction d'un plan approuvé va dans le plan. Puis **relance un ouvrier neuf** |
