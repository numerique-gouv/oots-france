...
3. **La documentation du dépôt** : `CLAUDE.md`, `docs/glossaire.md` pour un terme, et le document propriétaire du sujet d'après le tableau « une information, un endroit ». Pour une dépendance (Domibus, eDelivery, un annuaire de la Commission), sa doc publiée, puis sa source.
