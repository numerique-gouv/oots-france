...
| [`douanier`](.claude/skills/douanier/SKILL.md) | Code review, for specifications: judges whether a ticket is implementable as written — form, content, actionability — opens one comment thread per finding, and confirms or corrects the status `spec-nerd` set |
